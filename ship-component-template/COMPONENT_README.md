...
[Ship](https://github.com/paralect/ship) is a tool which help you setup your new product in matter of minutes. Ship is based on Stack. Stack is an number of open-source components, resulted from years of hard work on a number of awesome products. We carefully select, document and share our production-ready knowledge with you.
